...
{
    public double MaxGroundSpeed { get; init; } = 4.0;
    public double TurnSpeed { get; init; } = 3.0;
    public double TaxiLights { get; init; } = 3.0;
    public double Total => MaxGroundSpeed + TurnSpeed + TaxiLights;
}

public sealed class TakeoffWeights
{
    public double Bounce { get; init; } = 1.5;
    public double TailStrike { get; init; } = 2.5;
    public double BankAngle { get; init; } = 2.0;
    public double PitchAngle { get; init; } = 1.5;
    public double LandingLightsOnBeforeTakeoff { get; init; } = 1.0;
    public double LandingLightsOffByFl180 { get; init; } = 1.0;
...
{
    public double AltitudeHold { get; init; } = 4.0;
    public double FlightLevelCapture { get; init; } = 2.0;
    public double SpeedStability { get; init; } = 2.0;
...
{
    public double SpeedCompliance { get; init; } = 3.0;
    public double BankAngle { get; init; } = 2.5;
    public double PitchAngle { get; init; } = 2.0;
    public double GForce { get; init; } = 1.0;
    public double LandingLightsOnByFl180 { get; init; } = 1.5;
...
public sealed class ApproachWeights
{
    ...
    public double FlapsConfiguredAt500Agl { get; init; } = 2.0;
    public double StabilizedVerticalSpeed { get; init; } = 3.0;
    public double StabilizedBankAngle { get; init; } = 2.0;
    public double StabilizedPitchAngle { get; init; } = 1.5;
...
{
    public double TouchdownZone { get; init; } = 6.0;
    public double VerticalSpeed { get; init; } = 5.0;
    public double GForce { get; init; } = 4.0;
    public double Bounce { get; init; } = 5.0;

    /// <summary>VS below this threshold earns full marks — no deduction.</summary>
    public double VerticalSpeedPerfectFpm { get; init; } = 400;

    /// <summary>VS above this threshold is an automatic fail for the landing phase.</summary>
    public double VerticalSpeedAutoFailFpm { get; init; } = 600;

    /// <summary>G-force below this threshold earns full marks — no deduction.</summary>
    public double GForcePerfect { get; init; } = 1.3;

    /// <summary>G-force above this threshold is an automatic fail for the landing phase.</summary>
    public double GForceAutoFail { get; init; } = 1.5;
...
{
    public double LandingLightsOff { get; init; } = 1.0;
    public double StrobesOff { get; init; } = 1.0;
    public new double MaxGroundSpeed { get; init; } = 1.5;
    public new double TurnSpeed { get; init; } = 1.0;
    public new double TaxiLights { get; init; } = 0.5;
...
{
    public double ParkingBrakeSetAtGate { get; init; } = 2.5;
    public double GateArrivalPrecision { get; init; } = 2.5;
    public double Total => ParkingBrakeSetAtGate + GateArrivalPrecision;
}
